 ...
 * print, two lines, and a way through from anywhere on the page.
 *
...
export function Farewell({ onEnter }: { onEnter: () => void }) {
  return (
    <div className="farewell" onClick={onEnter}>
...
/**
 * Keeps the application unmounted while the farewell is on screen: no map or
 * panorama for a visitor who only came to read one sentence.
 */
